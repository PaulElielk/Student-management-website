<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo">Student Authentication Page
        </router-link>
        ...
        <div class="icons">
            ...
            <div v-if="!user" class="fas fa-user account" @click="showLog">
                <ul class="drop-down-select">
                    ...
                    <li>
                        <router-link @click="scrollToTop()" to="/admin">login as admin</router-link>
                    </li>
                </ul>
            ...
            <div v-else class="fas fa-user account" style="background: #f38609;color: white;" @click="showLog">
                <ul class="drop-down-select">
                    <li>
                        <router-link @click="scrollToTop()" to="/account">my account</router-link>
                    </li>
                    <li>
