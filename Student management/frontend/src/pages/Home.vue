<template>
    <div>
        <div class="home-main">
            <div class="content">
                <span>welcome to our students Authentication system</span>
                <h3>Get access to your informations in one click</h3>
              
                <h4>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</h4>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel officiis harum libero animi impedit vero debitis quae. Sapiente voluptate optio ratione quam consectetur ullam id ab vitae. Illo, obcaecati saepe.</p>
                
                <!-- Show login button only if user is not logged in -->
                <router-link v-if="!user" @click="scrollToTop()" to="/login" class="btn">login now</router-link>
                
                <!-- Show my account button if user is logged in -->
                <router-link v-else @click="scrollToTop()" to="/account" class="btn btn-account">my account</router-link>
            </div>
            <div class="image">
